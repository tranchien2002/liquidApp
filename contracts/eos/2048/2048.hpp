...
CONTRACT_START()
	...
	private:
		...
		void sort_rank(uint64_t date, name username, long int score);
	...
	public:
		...
		[[eosio::action]]
		void endgame(player_struct payload, vector<vector<uint8_t>> mapState, long int score, uint64_t date);
	VACCOUNTS_APPLY(((player_struct)(login))((player_struct)(startgame)))
