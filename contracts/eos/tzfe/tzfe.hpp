...
[[eosio::action]] void login(player_struct payload);

[[eosio::action]] void startgame(player_struct payload);

// [[eosio::action]]
// gameState continuegame(player_struct payload);

[[eosio::action]] void savegame(player_struct payload, vector<vector<uint8_t>> mapState, long int score);

[[eosio::action]] void endgame(player_struct payload, vector<vector<uint8_t>> mapState, long int score, std::string date);
